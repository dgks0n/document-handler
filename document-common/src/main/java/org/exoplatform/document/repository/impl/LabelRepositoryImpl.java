 ...
 * @version LabelRepositoryImpl.java Nov 30, 2013
 * 
 */
public class LabelRepositoryImpl extends CrudRepositoryImpl<Label, String> implements
        LabelRepository {

    public LabelRepositoryImpl(HibernateJpaRepository repository) {
        super(repository);
    }
