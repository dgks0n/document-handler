...
public class ClassFileFilterIsA implements IClassFileFilter, FileFilter {
   ...
   */
	 ...
	 * </p>
	 * <p>
	 * This method may be called several times. The accept method will return
	 * true if the given Class is derived from any of the internal super
	 * classes.
	 * </p>
	 * 
	 * @param c
	...
	/**
	 * Tries to detect (from the file path and the Classloaders urls) and load
	 * the corresponding class and delegates to {@link #accept(Class)}.
	 * 
