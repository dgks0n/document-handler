...
public final class JChardetFacade extends AbstractCodepageDetector implements nsICharsetDetectionObserver {
   ...
   */
	 ...
	 * </ol>
	 * ASCII indeed is never detected as possible: No internal verifier exists
	 * for ASCII, as all Charsets support ASCII. The possibility of ASCII is
	 * detected, when no Charset has been excluded: The amount of possible
	 * Charsets is equal to the amount of all detectable Charsets.
	 * </p>
	 * 
	 * @param guessing
	 *            The guessing to set.
