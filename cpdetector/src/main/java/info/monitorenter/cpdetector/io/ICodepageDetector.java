...
public interface ICodepageDetector extends Serializable, Comparable {
	 ...
	 * </p>
	 * <p>
	 * Detect the codepage of the document pointed to by the URL argument. If
	 * the codepage could not be detected, null has to be returned. If the given
	 * URL does not point to a document or it is not possible to open the
	 * document specified by the given URL, an IOException is thrown.
	 * </p>
	 * 
	 ...
	 * 
	 * @param length
	 *            The amount of bytes to take into account. This number should
