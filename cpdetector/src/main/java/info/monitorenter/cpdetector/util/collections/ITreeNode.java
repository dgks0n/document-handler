...
public interface ITreeNode {
	 ...
	 * </p>
	 * <p>
	 * Subsequent calls to this method should not change the state to
	 * "unmarked".
	 * </p>
	 * 
	 */
	...
	/**
	 * <p>
	 * The {@link java.util.Iterator}returned will not traverse the whole
	 * subtree but only the direct child nodes of this <tt>ITreeNode</tt>.
	 * </p>
	 * 
	 ...
	 * 
	 * @param node
	 *            The new child <tt>ITreeNode</tt> whose parent this instance
	 *            will become.
	 ...
	 * childs. This operation should delegate to
	 * {@link #addChildNode(ITreeNode)}.
	 * </p>
	 * 
	 * @param nodes
	 ...
	 * 
	 * @param userObject
	 *            The Object that should be carried by the new
	 *            <tt>ITreeNode</tt> or null, if no one is desired.
	 ...
	 * 
	 * @param node
	 *            A <tt>ITreeNode</tt> that migth possibly linked to (or be)
	 *            this instance by the means of the equals operation.
	...
	public static class DefaultTreeNode implements ITreeNode, Comparable<ITreeNode> {
		 ...
		 * <tt>ITreeNode</tt> which will get assigned this node to be it's
		 * father, while this instance will store the new node in it's list
		 ...
		 * while this instance will store the given node in it's list if not
		 * null (unconditionally: e.g. no test, if already contained).
		 * <p>
		 * 
		 * @param node
		 ...
		 * 
		 * @see
		 * aw.util.collections.ITreeNode#containsNode(aw.util.collections.ITreeNode
		 * )
		 */
		 ...
		 * 
		 * @see
		 * aw.util.collections.ITreeNode#removeChild(aw.util.collections.ITreeNode
		 * )
		 */
		public boolean removeChild(ITreeNode node) {
		 ...
		 * 
		 * @see
		 * aw.util.collections.ITreeNode#setParent(aw.util.collections.ITreeNode
		 * )
		 */
		 ...
		 * 
		 * @see
		 * aw.util.collections.ITreeNode#addChildNodes(aw.util.collections.ITreeNode
		 * [])
		 */
