...
public final class SingletonLoader {
	...
	/**
	 * High-level method for instantiation of a new instance of the class
	 * specified by the given fully qualified class name with singleton
	...
	/**
	 * Dynamic instantiation of the given type with singleton retrieval support
	 * as described in this class description.
	 * 
	 */
				...
				if ((modifiers & Modifier.PUBLIC) != 0) {
					...
					if (m.getParameterTypes().length == 0) {
						...
						if (m.getReturnType() == c) {
							// searching for substring "instance" in method
							// name:
