...
public class ClassFileChooser extends JFileChooser {
	...
	/**
	 * <p>
	 * Note that not only the FileFilter instances control the acceptance but
	 * also the added {@link IClassFileFilter} instances.
	 * </p>
	 * 
	 ...
	 * ClassFileFilters are allowd at the same time. This is eaysier to
	 * implement as it is not planned to let the UI select the ClassFileFilter
	 * to use but only the application (by now).
	 * </p>
	 * <P>
	 * The given classfile is accepted, if all ClassFileFilter instances accept
	 * it (logical AND).
	 * </p>
	 * 
	...
	static class URLFileSystemView extends FileSystemView {
		 ...
		 * 
		 * @see
		 * javax.swing.filechooser.FileSystemView#getParentDirectory(java.io
		 * .File)
		 */
		 ...
		 * 
		 * @see
		 * javax.swing.filechooser.FileSystemView#getSystemDisplayName(java.
		 * io.File)
		 */
		 ...
		 * 
		 * @see
		 * javax.swing.filechooser.FileSystemView#getSystemTypeDescription(java
		 * .io.File)
		 */
