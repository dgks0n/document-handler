...
public abstract class ACmdLineArgsInheritor {
	 ...
	 * <p>
	 * Subclasses may specify more options in their constructor by invoking the
	 * protected method #addOption(String,CmdLineParser.Option).
	 * <p>
	 */
	 ...
	 * options. Later on they can retrieve those options by using method
	 * <tt>getParsedCmdLineOption(String key)</tt> and do whatever they desire
	 * with the value then contained within the option.
	 * 
	 * @param key
	 *            The same key as used for
	 *            <tt>getParsedCmdLineOption(String key)</tt>
	 */
	...
	/**
	 * <p>
	 * This method has to be called initially by the code using this instance in
	 * order to configure.
	 * </p>
	 * <p>
	 * Every subclass has to call <code>super.parseArgs(cmdLineArgs)</code> and
	 * then retrieve the options needed from the returned CmdLineParser!
	 * </p>
	 * 
	 * @param cmdLineArgs
	 */
