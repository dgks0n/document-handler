...
public final class StringUtil {
	 ...
	 * 
	 * @param separator
	 *            put in-between each array element in the resulting string.
	 * 
	 * @param isArr
	 *            The Array to represent as String.
	 * 
	...
	/**
	 * Little String output - helper that modifies the given LinkedList by
	 * getting it's Objects and replace them by their toString() -
	 * representation.
	 * <p>
	 * 
	 * What is special? <br>
	 * If an Object in the given List is an Array (of Objects or primitive data
	 * types) reflection will be used to create a String - representation of
	 * them. The changes are reflected in the Objects that are in the given
	 * List. So keep a reference to it. If you are sure, that your List does not
	 ...
	 * method. This method or better: the given List is only thread - safe if
	 * the list is synchronized.
	 * <p>
	 * 
	 * A clever VM (hotspot) will be able to inline this function because of
	 * void return.
	 * <p>
	 * 
	 * @param objects
	 *            the List of objects that will be changed to a list of the
	 *            String representation of the Objects with respect to special
	 *            array treatment.
	 * 
	 */
	...
	/**
	 * This may be useful for comparison of canonical paths. For two strings a,b
	 * the prefix intersection of a and b is returned on the key side and the
	 * tail of b that did not match on the value side. <br>
	 * Example:
	 * <table border="1">
	 * <tr>
	 * <th>a</th>
	 ...
	 * </tr>
	 * </table>
	 * Note that the prefix is not searched within the strings. Both strings
	 * have to have a common prefix (no skipping until identical parts are
	 * found).
	 */
	...
	/**
	 * Appends the necessary amount of spaces to the string until it has the
	 * givn length. No Exception is thrown, if the length of the String is
	 * shorter than the given length, but nothing will happen and a message will
	 * be printed to the System.out.
	 * 
	 * 
	 * @param s
	 ...
	 * their toString() - representation concatenated with the necessary amount
	 * of white spaces that every String in the List will have the same amount
	 * of characters.
	 * <p>
	 * 
	 * Only use this method in following case: <br>
	 * <ul>
	 * <li>You have got an AbstractList or subclass containing Objects you do
	 * not know.</li>
