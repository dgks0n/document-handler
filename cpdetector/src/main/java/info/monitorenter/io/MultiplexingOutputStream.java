...
public class MultiplexingOutputStream extends OutputStream {
	 ...
	 * 
	 * @param delegate
	 *            another stream that will receive any write that is done on
	 *            this instance.
	 */
	...
	/**
	 * Removes the given output stream from the list of delegates multiplexed
	 * to.
	 * 
	 * @param delegate
	 *            a stream that should not receive any write that is done on
	 *            this instance any more.
	 * @return true if remove was successful, false if remove failed or - more
	 *         likely - the given stream was not on the list of delegates
	 *         before.
	 */
