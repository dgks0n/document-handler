...
public class LimitedInputStream extends FilterInputStream {
	 ...
	 * 
	 * @param limit
	 *            the amount of bytes that may be read from the given input
	 *            stream.
	 */
	 ...
	 * the result.
	 * <p>
	 * Additionally not only an EOF will limit the amount of bytes to read but
	 * also reaching the limit of this instance.
	 * <p>
	 * 
