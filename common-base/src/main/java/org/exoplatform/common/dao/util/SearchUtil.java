...
import org.exoplatform.common.dao.search.MutableSearch;
 ...
 *          
 * @version SearchUtil.java Nov 4, 2013
 */
public class SearchUtil {
	...
	public static void addField(MutableSearch search, Field field) {
	 ...
	 * map.
	 */
	public static void addField(MutableSearch search, String property, int operator) {
		if (property == null)
			return; // null properties do nothing, don't bother to add them.
	 ...
	 */
	public static void addField(MutableSearch search, String property, int operator, String key) {
	...
	public static void addFilter(MutableSearch search, Filter filter) {
	 ...
	 */
	public static void addFilterCustom(MutableSearch search, String expression) {
	 ...
	 */
	public static void addFilterCustom(MutableSearch search, String expression, Object... values) {
	 ...
	 */
	public static void addFilterCustom(MutableSearch search, String expression, Collection<?> values) {
		addFilter(search, Filter.custom(expression, values));
	}
	 ...
	 */
	public static void addSort(MutableSearch search, String property, boolean desc) {
	 ...
	 * if <code>desc == true</code>.
	 */
	public static void addSort(MutableSearch search, String property, boolean desc, boolean ignoreCase) {
		if (property == null)
			return; // null properties do nothing, don't bother to add them.
	...
	public static void removeFetch(MutableSearch search, String property) {
		if (search.getFetches() != null)
			search.getFetches().remove(property);
	}

	public static void removeField(MutableSearch search, Field field) {
		if (search.getFields() != null)
			search.getFields().remove(field);
	}

	public static void removeField(MutableSearch search, String property) {
		if (search.getFields() == null)
			return;
	...
	public static void removeField(MutableSearch search, String property, String key) {
		if (search.getFields() == null)
			return;
	...
	public static void removeFilter(MutableSearch search, Filter filter) {
		List<Filter> filters = search.getFilters();
		if (filters != null)
	...
	public static void removeSort(MutableSearch search, Sort sort) {
	...
	public static void clear(MutableSearch search) {
		...
		clearPaging(search);
		clearFetches(search);
		search.setResultMode(SearchImmutable.RESULT_AUTO);
		search.setDisjunction(false);
	}

	public static void clearFetches(MutableSearch search) {
		if (search.getFetches() != null)
			search.getFetches().clear();
	}

	public static void clearFields(MutableSearch search) {
		if (search.getFields() != null)
			search.getFields().clear();
	}

	public static void clearFilters(MutableSearch search) {
		if (search.getFilters() != null)
			search.getFilters().clear();
	}

	public static void clearPaging(MutableSearch search) {
		search.setFirstResult(-1);
		search.setPage(-1);
		search.setMaxResults(-1);
	}

	public static void clearSorts(MutableSearch search) {
		if (search.getSorts() != null)
	 ...
	 * the search.
	 */
	public static void mergeSortsBefore(MutableSearch search, List<Sort> sorts) {
	 ...
	 * the search.
	 */
	public static void mergeSortsBefore(MutableSearch search, Sort... sorts) {
	 ...
	 * the search.
	 */
	public static void mergeSortsAfter(MutableSearch search, List<Sort> sorts) {
		List<Sort> list = search.getSorts();
		if (list == null) {
			list = new ArrayList<Sort>();
			search.setSorts(list);
	 ...
	 * the search.
	 */
	public static void mergeSortsAfter(MutableSearch search, Sort... sorts) {
	 ...
	 * the search.
	 */
	public static void mergeFetches(MutableSearch search, List<String> fetches) {
	 ...
	 */
	public static void mergeFiltersAnd(MutableSearch search, List<Filter> filters) {
	 ...
	 */
	public static void mergeFiltersOr(MutableSearch search, List<Filter> filters) {
		List<Filter> list = search.getFilters();
		if (list == null) {
			list = new ArrayList<Filter>();
			search.setFilters(list);
	 ...
	 * the search.
	 */
	public static void mergeFieldsBefore(MutableSearch search, List<Field> fields) {
	 ...
	 * the search.
	 */
	public static void mergeFieldsAfter(MutableSearch search, List<Field> fields) {
		List<Field> list = search.getFields();
		if (list == null) {
			list = new ArrayList<Field>();
			search.setFields(list);
	 ...
	 * </ul>
	 */
	public static int calcFirstResult(SearchImmutable search) {
	 ...
	 * properties.
	 */
	public static MutableSearch shallowCopy(SearchImmutable source, MutableSearch destination) {
	 ...
	 * properties.
	 */
	public static MutableSearch shallowCopy(SearchImmutable source) {
	 ...
	 */
	public static <T extends MutableSearch> T copy(SearchImmutable source, T destination) {
	 ...
	 * collections are not duplicated; they still point to the same objects.
	 */
	public static MutableSearch copy(SearchImmutable source) {
	 ...
	 */
	public static boolean equals(SearchImmutable search, Object obj) {
		if (search == obj)
			return true;
		if (!(obj instanceof SearchImmutable))
			return false;
		SearchImmutable s = (SearchImmutable) obj;
	 ...
	 */
	public static int hashCode(SearchImmutable search) {
		int hash = 1;
	 ...
	 * search.
	 */
	public static String toString(SearchImmutable search) {
		...
		switch (search.getResultMode()) {
			case SearchImmutable.RESULT_AUTO:
				sb.append("AUTO");
				break;
			...
			case SearchImmutable.RESULT_MAP:
				sb.append("MAP");
				break;
			case SearchImmutable.RESULT_SINGLE:
				sb.append("SINGLE");
				break;
			default:
