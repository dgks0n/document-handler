 ...
 *          
 * @version BaseSearchProcessor.java Nov 4, 2013
 */
public abstract class BaseSearchProcessor {
	...
	protected MetadataHandler metadataUtil;

	protected String rootAlias = "_it";

	protected static final String ROOT_PATH = "";

	protected BaseSearchProcessor(int qlType, MetadataHandler metadataUtil) {
	 ...
	 * the constructor.
	 */
	public MetadataHandler getMetadataUtil() {
		return metadataUtil;
	}
	 ...
	 */
	public String generateQL(Class<?> entityClass, SearchImmutable search, List<Object> paramList) {
		if (entityClass == null)
	 ...
	 */
	public String generateRowCountQL(Class<?> entityClass, SearchImmutable search, List<Object> paramList) {
		if (entityClass == null)
			throw new NullPointerException("The entity class for a search cannot be null");
