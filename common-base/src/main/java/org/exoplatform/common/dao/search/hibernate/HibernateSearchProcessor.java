 ...
 *          
 * @version HibernateSearchProcessor.java Nov 4, 2013
 */
public class HibernateSearchProcessor extends BaseSearchProcessor {
	...
	public static HibernateSearchProcessor getInstanceForSessionFactory(SessionFactory sessionFactory) {
		...
		if (instance == null) {
			instance = new HibernateSearchProcessor(HibernateMetadataHandler.getInstanceForSessionFactory(sessionFactory));
			map.put(sessionFactory, instance);
		}
		return instance;
	}

	private HibernateSearchProcessor(HibernateMetadataHandler mdu) {
	...
	public List search(Session session, SearchImmutable search) {
		if (search == null)
			return null;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public List search(Session session, Class<?> searchClass, SearchImmutable search) {
	 ...
	 * @see SearchImmutable
	 */
	public int count(Session session, SearchImmutable search) {
		if (search == null)
			return 0;
	 ...
	 * @see SearchImmutable
	 */
	public int count(Session session, Class<?> searchClass, SearchImmutable search) {
		if (searchClass == null || search == null)
			return 0;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public SearchResult searchAndCount(Session session, SearchImmutable search) {
		if (search == null)
			return null;
	 ...
	 */
	@SuppressWarnings("unchecked")
	public SearchResult searchAndCount(Session session, Class<?> searchClass, SearchImmutable search) {
		if (searchClass == null || search == null)
			return null;
	 ...
	 */
	public Object searchUnique(Session session, SearchImmutable search) throws NonUniqueResultException {
		if (search == null)
			return null;
	 ...
	 */
	public Object searchUnique(Session session, Class<?> entityClass, SearchImmutable search) throws NonUniqueResultException {
		if (search == null)
			return null;
	...
	private void addResultMode(Query query, SearchImmutable search) {
