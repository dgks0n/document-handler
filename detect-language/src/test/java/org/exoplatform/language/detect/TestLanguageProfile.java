...
public class TestLanguageProfile {
  ...
  /**
   * Test method for
   * {@link com.cybozu.labs.langdetect.util.LanguageProfile#LanguageProfile()}.
   */
  @Test
  ...
  /**
   * Test method for
   * {@link com.cybozu.labs.langdetect.util.LanguageProfile#LanguageProfile(java.lang.String)}
   * .
   */
  @Test
  ...
  /**
   * Test method for
   * {@link com.cybozu.labs.langdetect.util.LanguageProfile#addNGramToProfile(java.lang.String)}
   * .
   */
  @Test
  ...
  public final void testAddIllegally1() {
    profile = new LanguageProfile(); // Illegal ( available for only JSONIC )
                                     // but ignore
  ...
  public final void testAddIllegally2() {
    profile = new LanguageProfile("en");
    profile.addNGramToProfile("a");
    profile.addNGramToProfile(""); // Illegal (string's length of parameter must
                                   // be between 1 and 3) but ignore
  ...
  /**
   * Test method for
   * {@link com.cybozu.labs.langdetect.util.LanguageProfile#omitLessFrequency()}
   * .
   */
  @Test
  public final void testOmitLessFreq() {
    profile = new LanguageProfile("en");
    String[] grams = "a b c \u3042 \u3044 \u3046 \u3048 \u304a \u304b \u304c \u304d \u304e \u304f"
        .split(" ");
    for (int i = 0; i < 5; ++i)
      for (String g : grams) {
